...
public class Patient {
	...
	public String generateStringFromPublicKey(PublicKey pubKey) {
		return new String(Base64.encode(pubKey.getEncoded())); //not working bc i unplugged the external drive, i need to movce the JAR files into the aegischain folder and then re add them (project properties java buiild path) so then itll work
	}
